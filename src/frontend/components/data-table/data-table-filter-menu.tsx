/** biome-ignore-all lint/a11y/useSemanticElements: falsePositive */
"use client";
...
import { DataTableRangeFilter } from "@/frontend/components/data-table/data-table-range-filter";
...
import {
    ...
    getFilterOperators,
} from "@/frontend/lib/data-table";
import { formatDate } from "@/frontend/lib/format";
import { generateId } from "@/frontend/lib/id";
import { getFiltersStateParser } from "@/frontend/lib/parsers";
...
export function DataTableFilterMenu<TData extends RowData>({
    ...
    const [selectedColumn, setSelectedColumn] =
        React.useState<Column<TableFeaturesConfig, TData> | null>(null);
    ...
    const onFilterAdd = React.useCallback(
        (column: Column<TableFeaturesConfig, TData>, value: string) => {
...
interface DataTableFilterItemProps<TData extends RowData> {
    ...
    filterItemId: string;
    columns: Column<TableFeaturesConfig, TData>[];
    onFilterUpdate: (
        filterId: string,
        updates: Partial<Omit<ExtendedColumnFilter<TData>, "filterId">>,
    ) => void;
                ...
                <CommandGroup>
                    ...
                    >
                        {isEmpty ? (
                            <>
                                <Text />
                                <span>Escribe para añadir filtro...</span>
                            </>
                        ) : (
                            <>
                                <BadgeCheck />
        ...
        case "boolean": {
            ...
            return (
                ...
                >
                    ...
                    >
                        <SelectValue
                            placeholder={filter.value ? "Verdadero" : "Falso"}
                        />
                    </SelectTrigger>
